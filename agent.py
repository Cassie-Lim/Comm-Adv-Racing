...
class Agent(nn.Module):
    def __init__(self, num_actions, comm_size, device, num_pistons, comm_size_compressed=32):
        super().__init__()
        ...
        self.device = device
        self.comm_aggregator = MultiAgentAttention(input_dim=comm_size, hidden_dim=8, output_dim=self.comm_size_compressed, n_heads=4)
